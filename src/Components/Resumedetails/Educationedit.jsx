...
const Educationedit = (props) => {
  ...
  useEffect(() => {
    console.log(props.editingoedu)
    setMakeformdata({
      class: props.editingoedu.course,
      institution: props.editingoedu.institution,
      startyear: props.editingoedu.startyear,
      endyear: props.editingoedu.endyear,
      marks: props.editingoedu.marks
    })
  }, [props.editingoedu]);
  ...
  const saveThisEducation = () => {
    ...
    if (flag) {
      ...
      var education = {};
      education.eduid = props.editingoedu.eduid
    ...
    <>
      ...
      <div class="mt-3">
        ...
        <div class="input_box_text px-3 d-flex flex-row">
          ...
          <input onChange={update} name="institution" class="w-100  p-large" type="text" value={makeformdata.institution} />
        </div>
      ...
      <div class="mt-3">
        <div class=" ">
          <div class="h4"> Enter Your Grade
            <span class="p-small cursor_pointer text-danger tt" data-bs-toggle="tooltip" data-bs-placement="left" title="Enter your gpa (0-4)" onClick={showGpaalert}>(<i class="fa fa-info" aria-hidden="true"></i>)</span>
          </div>
        </div>
        <div class="input_box_text px-3 d-flex flex-row">
          <div class="px-3 py-2">
      ...
      <div class="mt-2">
        ...
        <div class="top_header_button_1 h3 p-3 w-100 cursor_pointer text-center" onClick={saveThisEducation}>
          Update This Education
          <span class=" px-3 "><i class="fa fa-pencil-square" aria-hidden="true"></i> </span>
        </div>
      </div>
    </>
  )
