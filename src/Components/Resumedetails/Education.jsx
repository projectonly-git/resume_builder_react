  ...
  if (props.editingornew === 0) {
    return (
      <>
        ...
        <div class="mt-3">
          <div class=" ">
            <div class="h4"> Enter Your Grade   <span class="p-small cursor_pointer text-danger" onClick={showGpaalert}>(<i class="fa fa-info" aria-hidden="true"></i>)</span></div>
          </div>
          <div class="input_box_text px-3 d-flex flex-row">
            <div class="px-3 py-2">
              <i class="fa fa-percent fa-2x" aria-hidden="true"></i>
            </div>
            <input onChange={update} name="marks" class="w-100  p-large" type="text" placeholder="4.3" />
          </div>
        </div>
      ...
      <>
        <div class="mt-3">
          ...
          <div class="input_box_text px-3 d-flex flex-row">
            ...
            <input onChange={update} name="class" class="w-100  p-large" type="text" value={props.editingoedu.course} />
          </div>
          <div class="p-small text-danger py-2"> {degreew} </div>
        ...
        <div class="mt-3">
          ...
          <div class="input_box_text px-3 d-flex flex-row">
            ...
            <input onChange={update} name="institution" class="w-100  p-large" type="text" value={props.editingoedu.institution} />
          </div>
          <div class="p-small text-danger py-2"> {insw} </div>
        </div>
        ...
        <div class="mt-3 ">
          ...
          <div class="d-flex flex-row">
            <div class="">
              ...
              {/*<input onChange={update} name="startyear" class=" input_box_text px-3 p-large" type="number" value={makeformdata.startyear} />*/}
              <div class=" input_box_text py-3 px-4 h6 ">
                <select value={props.editingoedu.startyear} onChange={handleChangeStart}>
                  <option value='2000'>2000</option>
                  <option value='2001'>2001</option>
                  <option value='2002'>2002</option>
                  <option value='2003'>2003</option>
            ...
            <div class="px-3 ">
              ...
              {/*<input onChange={update} name="endyear" class=" input_box_text px-3 p-large" type="number" value={makeformdata.endyear} />*/}
              <div class={"input_box_text py-3 px-4 h6 " + showorhide}>
                <select value={props.editingoedu.endyear} onChange={handleChangeEnd}>
                  <option value='2000'>2000</option>
                  <option value='2001'>2001</option>
                  <option value='2002'>2002</option>
                  <option value='2003'>2003</option>
        ...
        <div class="mt-3">
          ...
          <div class="input_box_text px-3 d-flex flex-row">
            ...
            <input onChange={update} name="marks" class="w-100  p-large" type="text" value={props.editingoedu.marks} />
          </div>
        </div>
